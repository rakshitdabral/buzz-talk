  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div className="lg:hidden  flex gap-10 justify-end item-center">
          ...
          <img
            ...
            alt="menu"
            className={`${toggle ? "mr-[10px]" : ""}w-[28px] h-[28px]  object-contain cursor-pointer z-50`}
          ></img>
          ...
          >
            <ul className="flex flex-col justify-start mt-[80px] items-start gap-4 list-none">
              {navLinks.map((link) => (
                ...
                >
                  <a className="hover:text-sky-500 hover:underline" href={`#${link.id}`}>{link.title}</a>
                </li>
              ))}
            </ul>
          </div>
